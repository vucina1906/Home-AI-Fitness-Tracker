...
def calculate_responsiveness(angle, min_angle=40, max_angle=140):
    if angle > max_angle:
...
# Main function for shoulder press logic
        ...
        while True:
            ...
            if results.pose_landmarks:
                ...
                if (left_elbow_angle > 150 and right_elbow_angle > 150 and 
                    left_shoulder_angle > 140 and right_shoulder_angle > 140):
                    if direction == 0:
                        counter += 0.5
                        direction = 1

                # Hands-Down Condition
                if (left_elbow_angle < 40 and right_elbow_angle < 40 and 
