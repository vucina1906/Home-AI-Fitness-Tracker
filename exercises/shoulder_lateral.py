...
# Main function for shoulder lateral exercise
def run_shoulder_lateral():
    ...
    with mp_pose.Pose(min_detection_confidence=0.7, min_tracking_confidence=0.7) as pose:
        ...
        while True:
            ...
            if results.pose_landmarks:
                ...
                left_responsiveness = calculate_responsiveness(left_shoulder_angle)
                right_responsiveness = calculate_responsiveness(right_shoulder_angle)
            ...
            cv2.imshow("Shoulder Lateral Exercise", frame)
