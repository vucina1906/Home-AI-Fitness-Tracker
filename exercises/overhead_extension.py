...
def calculate_responsiveness(angle, min_angle=90, max_angle=160):
    if angle < min_angle:
        return 0  # Minimum responsiveness for lower elbow angles
    elif angle > max_angle:
        return 1  # Maximum responsiveness for higher elbow angles
    else:
...
# Main function for overhead extension
def run_overhead_extension():
        ...
        while True:
            ...
            if results.pose_landmarks:
                ...
                if (left_shoulder_angle > 140 and right_shoulder_angle > 140 and 
                    left_elbow_angle > 120 and right_elbow_angle > 120):
                    if direction == 0:
                        counter += 0.5
                        direction = 1
            ...
            cv2.imshow("Overhead Extension Exercise", frame)
